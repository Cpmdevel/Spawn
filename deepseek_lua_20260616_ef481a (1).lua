-- ============================================================
--  🌱 FARMING GAME - FarmingGui.lua  v2.1 (Delta+ fix)
--  ✅ Executor compatible (getgenv / _G)
--  ✅ Robust remote retry & error handling
--  ✅ Real‑time seed shop & inventory updates
...
-- ── Locate Remotes (retry up to 20s) ──────────────────────
...
-- If critical remotes are missing, show a persistent warning
if not RE_UpdateUI then
    warn("[FarmingGui] Critical remote 'UpdateUI' missing – UI will not update.")
end
...
local titleLabel = makeLabel(topBar, "🌱 FARMING GAME",
    UDim2.new(1, -150, 1, 0),
    UDim2.new(0, 14, 0, 0),
...
plantBtn.MouseButton1Click:Connect(function()
    ...
    -- Keep plot selected? We'll deselect after planting to avoid confusion.
...
if RE_UpdateUI then
    RE_UpdateUI.OnClientEvent:Connect(function(data)
        ...
        -- Rebuild seed shop if catalog changed
...
print("✅ FarmingGui v2.1 (Delta‑ready) loaded!")